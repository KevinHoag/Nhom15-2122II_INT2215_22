...
bool loadMedia_4(int x, int fsize, SDL_Renderer *&gRenderer, LTexture *&gTextTexture_3) {
    ...
    SDL_Color textColor2 = {255, 155, 0};
    SDL_Color textColor3 = {55, 155, 0};
    if (x == 1) gTextTexture_3[0].loadfromrenderedtext(gRenderer, gFont, "A", textColor2);
    else gTextTexture_3[0].loadfromrenderedtext(gRenderer, gFont, "A", textColor3);
    ...
    gTextTexture_3[5].loadfromrenderedtext(gRenderer, gFont, "SHOOT: ENTER", textColor);
...
/*bool loadMedia_7(int x) {
    SDL_Color textColor = { 0, 0, 0 };
    SDL_Color textColor2 = {255, 155, 0};
    if (x == 1) gTextTexture_5[0].loadFromRenderedText( "YES", textColor2, TTF_OpenFont( "VGOUDYB.TTF", 100 ), gRenderer );
    else gTextTexture_5[0].loadFromRenderedText( "YES", textColor, TTF_OpenFont( "VGOUDYB.TTF", 100 ), gRenderer );
    if (x == 2) gTextTexture_5[1].loadFromRenderedText( "NO", textColor2, TTF_OpenFont( "VGOUDYB.TTF", 100 ), gRenderer );
    else gTextTexture_5[1].loadFromRenderedText( "NO", textColor, TTF_OpenFont( "VGOUDYB.TTF", 100 ), gRenderer );
    return 1;
}*/
